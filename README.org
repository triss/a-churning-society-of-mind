...
#+BEGIN_SRC clojure :noweb-ref dep-chesire
[cheshire "5.7.0"]
#+END_SRC

#+BEGIN_SRC clojure :noweb-ref dep-incanter
[incanter "1.5.7"]
#+END_SRC

#+BEGIN_SRC clojure :noweb-ref dep-http
[clj-http "2.3.0"]
#+END_SRC

#+BEGIN_SRC clojure :noweb-ref dep-nlp
[damionjunk/nlp  "0.3.0"]
#+END_SRC


#+BEGIN_SRC clojure :noweb-ref dep-java
  ;; jsoup - for cleaning up HTML
  [org.jsoup/jsoup "1.10.2"]

  ;; standford Core-NLP - natural language processing - (not used?)
